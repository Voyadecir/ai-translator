diff --git a/ai_translator/config.py b/ai_translator/config.py
new file mode 100644
index 0000000000000000000000000000000000000000..6d96b30bafaeb38e49d9d1cfc421be0a91750e6a
--- /dev/null
+++ b/ai_translator/config.py
@@ -0,0 +1,20 @@
+import os
