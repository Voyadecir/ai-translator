diff --git a/ai_translator/ocr.py b/ai_translator/ocr.py
new file mode 100644
index 0000000000000000000000000000000000000000..23616740a0f80960b2920dee81bb5c4d4124e79a
--- /dev/null
+++ b/ai_translator/ocr.py
@@ -0,0 +1,230 @@
+import asyncio
+import logging
